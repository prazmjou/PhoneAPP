...
const Games = () => {
  ...
  return (
    <AppstorePage title="Games">
      ...
      <List className="categories-list safe-areas-inset" noChevron dividers>
        <ListItem title="Indie" link="#">
          <span role="img" slot="media" aria-label="Indie">
            💎
          </span>
        </ListItem>
        <ListItem title="Casual" link="#">
          <span role="img" slot="media" aria-label="Casual">
            👾
          </span>
        </ListItem>
        <ListItem title="Strategy" link="#">
          <span role="img" slot="media" aria-label="Strategy">
            🏰
          </span>
        </ListItem>
        <ListItem title="Action" link="#">
          <span role="img" slot="media" aria-label="Action">
            ⚔️
          </span>
        </ListItem>
        <ListItem title="Racing" link="#">
          <span role="img" slot="media" aria-label="Racing">
            🏁
          </span>
        </ListItem>
      </List>
      ...
      <List className="quick-links-list safe-areas-inset" noChevron dividers>
        <ListItem title="Try Apple Arcade" link="#" />
        ...
        <ListItem title="About Personalisation" link="#" />
      </List>
