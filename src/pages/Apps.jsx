    ...
    <AppstorePage title="Apps">
      ...
      <List className="categories-list safe-areas-inset" noChevron dividers>
        <ListItem title="Apple Watch Apps" link="#">
          <span role="img" slot="media" aria-label="Apple Watch Apps">
            ⌚
          </span>
        </ListItem>
        <ListItem title="Photo & Video" link="#">
          <span role="img" slot="media" aria-label="Photo & Video">
            📷
          </span>
        </ListItem>
        <ListItem title="Entertaiment" link="#">
          <span role="img" slot="media" aria-label="Entertaiment">
            🍿
          </span>
        </ListItem>
        <ListItem title="Kids" link="#">
          <span role="img" slot="media" aria-label="Kids">
            🎈
          </span>
        </ListItem>
        <ListItem title="Social Networking" link="#">
          <span role="img" slot="media" aria-label="Social Networking">
            💬
          </span>
        </ListItem>
        <ListItem title="Lifestyle" link="#">
          <span role="img" slot="media" aria-label="Lifestyle">
            🛋️
          </span>
        </ListItem>
      </List>
