...
const AppDetails = ({ id, backText }) => {
  ...
  const totalVotes = Object.values(ratingVotes).reduce(
  ...
  return (
    <Page onPageInit={pageInit} onPageBeforeRemove={pageDestroy}>
      <Navbar transparent backLink={backText || 'Back'} className="app-navbar">
      ...
      <div className="app-props">
        <div className="app-props-wrap">
          <div className="app-props-item">
            <div className="app-props-item-title">930 Ratings</div>
            <div className="app-props-item-value">{app.rating}</div>
            <div className="app-props-item-label">
              <RatingStars rating={app.rating} />
            </div>
          </div>
          <div className="app-props-item">
            <div className="app-props-item-title">Age</div>
            <div className="app-props-item-value">12+</div>
            <div className="app-props-item-label">Years Old</div>
          </div>
          <div className="app-props-item">
            <div className="app-props-item-title">Developer</div>
            <div className="app-props-item-value">
              <i className="f7-icons">person_crop_square</i>
            </div>
            <div className="app-props-item-label">{app.developer.name}</div>
          </div>
          <div className="app-props-item">
            <div className="app-props-item-title">Language</div>
            <div className="app-props-item-value">EN</div>
            <div className="app-props-item-label">+1 More</div>
          </div>
          <div className="app-props-item">
            <div className="app-props-item-title">Size</div>
            <div className="app-props-item-value">
              {Math.ceil(app.size / 1_000_000)}
            </div>
            <div className="app-props-item-label">MB</div>
          </div>
        </div>
      </div>
      ...
      <div
        className={`block app-description ${
          showFullDescription ? 'app-description-full' : ''
        }`}
      >
          ...
          {[5, 4, 3, 2, 1].map((rating) => (
            <div className="app-ratings-votes-row" key={rating}>
              ...
              <div className="app-ratings-votes-progress">
                <span
                  style={{
                    width: `${(ratingVotes[rating] / totalVotes) * 100}%`,
                  }}
                />
              </div>
            </div>
      ...
      <div className="block app-reviews">
        <div className="app-review">
          ...
          <div className="app-review-text">
            ...
            laborum debitis natus cum quae est rerum cupiditate cumque delectus
            eaque ipsa, accusamus facilis deleniti consequuntur, aliquam soluta
            minima, eos exercitationem.
          </div>
        </div>
        <div className="app-review">
          <div className="app-review-header">
          ...
          <div className="app-review-text">
            ...
            pariatur laudantium, laborum sunt adipisci magni in doloremque neque
            error earum fugiat! Nihil molestias rem tenetur laboriosam illo
            similique nobis adipisci?
          </div>
        </div>
        <div className="app-review">
          <div className="app-review-header">
          ...
          <div className="app-review-text">
            ...
            suscipit cumque laborum modi, eaque, a consequuntur, pariatur et
            itaque. Vitae odio necessitatibus amet.
          </div>
        </div>
        <div className="app-review">
          <div className="app-review-header">
          ...
          <div className="app-review-text">
            ...
            ex! Architecto alias delectus, optio eos nostrum obcaecati repellat
            distinctio, ab, quam dolores voluptatem ex inventore facere expedita
        ...
        <div className="app-review">
          ...
          <div className="app-review-text">
            ...
            odit exercitationem eligendi maiores rerum quo, quos ullam quam!
            Quia facilis consequatur vitae cupiditate molestias maiores odit
            magnam quo itaque.
          </div>
        </div>
        <div className="app-review">
          ...
          <div className="app-review-text">
            ...
            ipsa accusantium qui praesentium, obcaecati quae illum, tempora
            molestias similique nihil sunt in tempore ipsam laborum illo maxime
            amet quos consectetur!
          </div>
        </div>
      </div>
        ...
        <>
          ...
          <div className="block">
            ...
            >
              ...
              <span>
                {formatDate(app.versions[app.versions.length - 1].release_date)}
              </span>
            </p>
      ...
      >
        ...
        <ListItem
          link={`https://apps.apple.com/developer/id${app.developer.id}`}
          external
          target="_blank"
